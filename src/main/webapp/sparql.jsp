                ...
                <section class="seccion-01" id="intro">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>SPARQL es un lenguaje de consulta para RDF basado en comparaci�n de patrones de triplas. Un patr�n de triplas es similar a una tripleta RDF, excepto que cada sujeto, predicado y objeto puede ser una variable.</P>
...
<!--                                <input type="hidden" name="body">
                            ...
                            <p>
                                ...
                                <ul>
                                    <li>
                                        <b>Variables:</b> El nombre de una variable es precedido por el signo de interrogaci�n "?". Identifica a la misma variable en cualquier lugar de una consulta.<br/>
                                    ...
                                    <li>
                                        ...
                                        <ul style="padding-left:20px;">
                                            <li><b>SELECT:</b> Devuelve todo, o un subconjunto de las variables vinculadas en una concordancia con un patr�n de b�squeda.</li>
                                            <li><b>CONSTRUCT:</b> Devuelve un grafo RDF construido mediante la sustituci�n de variables en un conjunto de plantillas de tripleta.</li>
                                            <li><b>ASK:</b> Devuelve una variable booleana indicando si la combinaci�n Sujeto-Predicado-Objeto de consulta existe en la ontolog�a RDF consultada.</li>
                                    ...
                                    <li>
                                        <b>Clausulas:</b>
                                        <ul style="padding-left:20px;">
                                            <li><b>WHERE:</b> patr�n de la consulta con una o m�s tripletas encerradas entre {}.</li>
                                            <li><b>DISTINCT:</b> asegura la unicidad de los resultados.</li>
                                            <li><b>FILTER:</b> permite imponer constricciones adicionales al patr�n de b�squeda.</li>
                                            <li><b>ORDER BY:</b> permite ordenar los resultados obtenidos de acuerdo a par�metros espec�ficos.</li>
